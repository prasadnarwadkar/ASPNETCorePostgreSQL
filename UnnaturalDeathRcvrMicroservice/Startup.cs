...
using MediatR;
using UnnaturalDeathsRcvrMicroservice.ServiceBus;
...
namespace Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMediatR(Assembly.GetExecutingAssembly(), typeof(IDeathDetailsUpdateBroadcastService).Assembly);
            ...
            services.AddTransient<IDeathDetailsUpdateBroadcastService, DeathDetailsUpdateBroadcastService>();

            services.AddHostedService<DeathDetailsReceiver>();
        }
